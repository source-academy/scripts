...
const chapter = 2;
const assessmentTitle = 'Game of Tones';
const extraLibrary = 'SOUNDS';
const contestFunction = 'sounds_contest_';
const contestFunctionPattern = /[_$a-zA-Z0-9<>]+_sounds_contest/g;
