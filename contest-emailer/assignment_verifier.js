...
//const submissions_2d = require('./submissions/BeautifulRunes.json');
...
const groups = [
  //{ name: 'Beautiful Runes', submissions: submissions_2d, fn: 'two_d_contest_', url: 'https://goo.gl/forms/xxx' }
  //{ name: '3D Runes', submissions: submissions_3d, fn: 'three_d_contest_', url: 'https://goo.gl/forms/xxx' },
  { name: 'The Choreographer', submissions: submissions_curve, fn: 'curve_contest_', url: 'https://goo.gl/forms/xxx' },
